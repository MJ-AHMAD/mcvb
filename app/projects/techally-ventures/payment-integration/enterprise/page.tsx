          ...
          <div className="max-w-md w-full space-y-8">
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-gray-600">
                Your Enterprise Plan request has been submitted successfully. We'll get back to you soon.
              </p>
            </div>
            <div className="mt-5">
  ...
  return (
    <div className="min-h-screen bg-muted">
      ...
      <main className="container py-12">
        <h1 className="text-4xl font-bold mb-8 text-center">Enterprise Payment Integration Plan</h1>
        <div className="max-w-2xl mx-auto">
          <div className="mb-8 p-6 bg-white rounded-lg shadow-md">
            ...
            <p className="text-2xl font-bold">Price: $1499</p>
          </div>
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <label htmlFor="monthly-revenue" className="block text-sm font-medium text-gray-700">
                Estimated Monthly Revenue
              </label>
              <Input id="monthly-revenue" name="monthly-revenue" type="text" required className="mt-1" />
            </div>
            <div>
              <label htmlFor="integration-needs" className="block text-sm font-medium text-gray-700">
              ...
              <Textarea
                ...
                rows={4}
                className="mt-1"
                placeholder="Describe your specific integration requirements"
                required
              />
            </div>
            <div>
