          ...
          <div className="max-w-md w-full space-y-8">
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-gray-600">
                Your Business Plan request has been submitted successfully. We'll get back to you soon.
              </p>
            </div>
            <div className="mt-5">
  ...
  return (
    <div className="min-h-screen bg-muted">
      ...
      <main className="container py-12">
        <h1 className="text-4xl font-bold mb-8 text-center">Business Payment Integration Plan</h1>
        <div className="max-w-2xl mx-auto">
          <div className="mb-8 p-6 bg-white rounded-lg shadow-md">
            ...
            <p className="text-2xl font-bold">Price: $799</p>
          </div>
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <Textarea
                ...
                rows={4}
                className="mt-1"
                placeholder="Tell us about your specific integration needs or any questions you have"
                required
              />
            </div>
            <div>
