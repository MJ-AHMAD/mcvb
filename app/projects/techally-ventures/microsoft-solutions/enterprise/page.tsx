          ...
          <div className="max-w-md w-full space-y-8">
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-gray-600">
                Your Enterprise Solutions request has been submitted successfully. We'll get back to you soon.
              </p>
            </div>
            <div className="mt-5">
  ...
  return (
    <div className="min-h-screen bg-muted">
      ...
      <main className="container py-12">
        <h1 className="text-4xl font-bold mb-8 text-center">Enterprise Solutions</h1>
        <div className="max-w-2xl mx-auto">
          <div className="mb-8 p-6 bg-white rounded-lg shadow-md">
            <h2 className="text-2xl font-bold mb-4">Plan Details</h2>
            <ul className="list-disc pl-6 mb-4">
              <li>Everything in Business Solutions</li>
            ...
            <p className="text-2xl font-bold">Price: $1999/month</p>
          </div>
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <Input id="employees" name="employees" type="number" required className="mt-1" />
            </div>
            <div>
              ...
              <Textarea
                ...
                rows={4}
                className="mt-1"
                placeholder="Please describe your specific enterprise requirements"
                required
              />
            </div>
            <div>
