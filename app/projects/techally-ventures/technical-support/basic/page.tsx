...
export default function BasicSupportPlanPage() {
          ...
          <div className="max-w-md w-full space-y-8">
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-gray-600">
                Your Basic Support Plan request has been submitted successfully. We'll get back to you soon.
              </p>
            </div>
            <div className="mt-5">
  ...
  return (
    <div className="min-h-screen bg-muted">
      ...
      <main className="container py-12">
        <h1 className="text-4xl font-bold mb-8 text-center">Basic Support Plan</h1>
        <div className="max-w-2xl mx-auto">
          <div className="mb-8 p-6 bg-white rounded-lg shadow-md">
            ...
            <p className="text-2xl font-bold">Price: $199/month</p>
          </div>
