...
export default function ProfessionalSEOPlanPage() {
          ...
          <div className="max-w-md w-full space-y-8">
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-gray-600">
                Your Professional SEO Plan request has been submitted successfully. We'll get back to you soon.
              </p>
            </div>
            <div className="mt-5">
  ...
  return (
    <div className="min-h-screen bg-muted">
      ...
      <main className="container py-12">
        <h1 className="text-4xl font-bold mb-8 text-center">Professional SEO Plan</h1>
        <div className="max-w-2xl mx-auto">
          <div className="mb-8 p-6 bg-white rounded-lg shadow-md">
            <h2 className="text-2xl font-bold mb-4">Plan Details</h2>
            <ul className="list-disc pl-6 mb-4">
              <li>Everything in Basic Plan</li>
              <li>Advanced Keyword Research (30 keywords)</li>
              <li>Technical SEO Audit</li>
              <li>Competitor Analysis</li>
              <li>Content Strategy</li>
              <li>Link Building (10 quality backlinks)</li>
              <li>Local SEO Optimization</li>
              <li>Weekly Performance Reports</li>
            </ul>
            <p className="text-2xl font-bold">Price: $899</p>
          </div>
