...
export default function EssentialUmrahExperiencePage() {
          ...
          <div className="max-w-md w-full space-y-8">
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-gray-600">
                Your Essential Umrah Experience booking request has been submitted successfully. We'll get back to you
                soon.
              </p>
            </div>
            <div className="mt-5">
  ...
  return (
    <div className="min-h-screen bg-muted">
      ...
      <main className="container py-12">
        <h1 className="text-4xl font-bold mb-8 text-center">Essential Umrah Experience</h1>
        <div className="max-w-2xl mx-auto">
          <div className="mb-8 p-6 bg-white rounded-lg shadow-md">
            <h2 className="text-2xl font-bold mb-4">Package Details</h2>
            <ul className="list-disc pl-6 mb-4">
              <li>10 days comprehensive Umrah package</li>
              <li>Comfortable 3-star hotel accommodations</li>
              <li>Group size: 20-30 pilgrims</li>
              <li>Guided spiritual journey</li>
              <li>Basic transportation services</li>
            </ul>
            <p className="text-2xl font-bold">Price: $1500 per person</p>
          </div>
