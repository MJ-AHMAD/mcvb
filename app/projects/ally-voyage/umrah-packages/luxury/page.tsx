...
export default function LuxuryUmrahRetreatPage() {
          ...
          <div className="max-w-md w-full space-y-8">
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-gray-600">
                Your Luxury Umrah Retreat booking request has been submitted successfully. We'll get back to you soon.
              </p>
            </div>
            <div className="mt-5">
  ...
  return (
    <div className="min-h-screen bg-muted">
      ...
      <main className="container py-12">
        <h1 className="text-4xl font-bold mb-8 text-center">Luxury Umrah Retreat</h1>
        <div className="max-w-2xl mx-auto">
          <div className="mb-8 p-6 bg-white rounded-lg shadow-md">
            <h2 className="text-2xl font-bold mb-4">Package Details</h2>
            <ul className="list-disc pl-6 mb-4">
              <li>12 days ultimate Umrah experience</li>
              <li>Luxurious 5-star hotel accommodations</li>
              <li>Exclusive group size: 10-15 pilgrims</li>
              <li>Private spiritual guide</li>
              <li>VIP transportation services</li>
              <li>Gourmet dining experiences</li>
              <li>Extended visits to historical Islamic sites</li>
              <li>Personalized concierge service</li>
            </ul>
            <p className="text-2xl font-bold">Price: $3500 per person</p>
          </div>
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <Input
                ...
                type="text"
                className="mt-1"
                placeholder="e.g., Suite, Connecting rooms"
              />
            </div>
            <div>
