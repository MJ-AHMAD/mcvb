...
export default function CoxsBazarSunsetBlissPage() {
          ...
          <div className="max-w-md w-full space-y-8">
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-gray-600">
                Your Cox's Bazar Sunset Bliss booking request has been submitted successfully. We'll get back to you
  ...
  return (
    <div className="min-h-screen bg-muted">
      ...
      <main className="container py-12">
        <h1 className="text-4xl font-bold mb-8 text-center">Cox's Bazar Sunset Bliss</h1>
          ...
          <Card className="mb-8">
            ...
            <CardContent>
              <ul className="list-disc pl-5 space-y-2">
                <li>3 days and 2 nights stay at a beachfront hotel</li>
                <li>Daily breakfast and dinner included</li>
                <li>Guided sunset walking tour</li>
                <li>Visit to Inani Beach</li>
                <li>Traditional Bengali dinner experience</li>
                <li>Round-trip transportation from Cox's Bazar Airport</li>
              </ul>
              <p className="mt-4 font-bold">Price: 15,000 BDT per person</p>
            </CardContent>
          </Card>

          <h2 className="text-2xl font-bold mb-4">Book Your Cox's Bazar Sunset Bliss Package</h2>
