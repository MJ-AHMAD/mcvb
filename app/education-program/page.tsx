          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-sky-100 hover:shadow-xl transition-all">
              ...
              <div className="p-6">
                ...
                <Button className="w-full bg-sky-600 hover:bg-sky-700">Learn More</Button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg border border-emerald-100">
              ...
              <div className="mt-6">
                <Button className="w-full">Learn About Our Printing Standards</Button>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-emerald-100">
              ...
              <div className="mt-6">
                <Button className="w-full">Join Our Research Network</Button>
              </div>
            </div>
          </div>
          ...
          <div className="mt-16 bg-emerald-900 text-white p-8 md:p-12 rounded-2xl shadow-xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="flex justify-center mt-8">
                <Button className="bg-white text-emerald-900 hover:bg-emerald-100 text-lg px-8 py-3">
